...
extern "C" {
    ...
    pub fn get_property(this: &AnimationPropertyDetails) -> Option<String>;
    ...
    pub fn get_running_on_compositor(this: &AnimationPropertyDetails) -> Option<bool>;
    ...
    pub fn get_values(this: &AnimationPropertyDetails) -> Option<::js_sys::Array>;
