...
extern "C" {
    ...
    pub fn get_data(this: &EncodedAudioChunkInit) -> Option<::js_sys::Object>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_timestamp(this: &EncodedAudioChunkInit) -> Option<f64>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_type_(this: &EncodedAudioChunkInit) -> Option<EncodedAudioChunkType>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "EncodedAudioChunkType")]
    ...
    pub fn set_type_(this: &EncodedAudioChunkInit, val: EncodedAudioChunkType);
}
#[cfg(web_sys_unstable_apis)]
