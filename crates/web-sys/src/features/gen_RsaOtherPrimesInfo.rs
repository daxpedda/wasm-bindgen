...
extern "C" {
    ...
    pub fn get_d(this: &RsaOtherPrimesInfo) -> Option<String>;
    ...
    pub fn get_r(this: &RsaOtherPrimesInfo) -> Option<String>;
    ...
    pub fn get_t(this: &RsaOtherPrimesInfo) -> Option<String>;
