...
extern "C" {
    ...
    pub fn get_format(this: &GpuVertexAttribute) -> Option<GpuVertexFormat>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "GpuVertexFormat")]
    ...
    pub fn get_offset(this: &GpuVertexAttribute) -> Option<f64>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_shader_location(this: &GpuVertexAttribute) -> Option<u32>;
    #[cfg(web_sys_unstable_apis)]
