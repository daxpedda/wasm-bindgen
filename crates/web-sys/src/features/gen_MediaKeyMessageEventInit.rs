...
extern "C" {
    ...
    pub fn get_message(this: &MediaKeyMessageEventInit) -> Option<::js_sys::ArrayBuffer>;
    ...
    pub fn get_message_type(this: &MediaKeyMessageEventInit) -> Option<MediaKeyMessageType>;
    #[cfg(feature = "MediaKeyMessageType")]
