...
extern "C" {
    ...
    pub fn get_a(this: &GpuColorDict) -> Option<f64>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_b(this: &GpuColorDict) -> Option<f64>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_g(this: &GpuColorDict) -> Option<f64>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_r(this: &GpuColorDict) -> Option<f64>;
    #[cfg(web_sys_unstable_apis)]
