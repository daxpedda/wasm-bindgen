...
extern "C" {
    ...
    pub fn get_data(this: &HidInputReportEventInit) -> Option<::js_sys::DataView>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_device(this: &HidInputReportEventInit) -> Option<HidDevice>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "HidDevice")]
    ...
    pub fn get_report_id(this: &HidInputReportEventInit) -> Option<u8>;
    #[cfg(web_sys_unstable_apis)]
