...
extern "C" {
    ...
    pub fn get_l10n_id(this: &L10nElement) -> Option<String>;
    ...
    pub fn get_local_name(this: &L10nElement) -> Option<String>;
    ...
    pub fn get_namespace_uri(this: &L10nElement) -> Option<String>;
    ...
    pub fn get_type_(this: &L10nElement) -> Option<String>;
    #[doc = "Change the `type` field of this object."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `L10nElement`*"]
    #[wasm_bindgen(method, setter = "type")]
    pub fn set_type_(this: &L10nElement, val: Option<&str>);
}
impl L10nElement {
