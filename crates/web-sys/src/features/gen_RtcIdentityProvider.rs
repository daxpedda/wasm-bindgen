...
extern "C" {
    ...
    pub fn get_generate_assertion(this: &RtcIdentityProvider) -> Option<::js_sys::Function>;
    ...
    pub fn get_validate_assertion(this: &RtcIdentityProvider) -> Option<::js_sys::Function>;
