...
extern "C" {
    ...
    pub fn get_source(this: &RtcRtpSourceEntry) -> Option<u32>;
    ...
    pub fn get_timestamp(this: &RtcRtpSourceEntry) -> Option<f64>;
    ...
    pub fn get_source_type(this: &RtcRtpSourceEntry) -> Option<RtcRtpSourceEntryType>;
    #[cfg(feature = "RtcRtpSourceEntryType")]
