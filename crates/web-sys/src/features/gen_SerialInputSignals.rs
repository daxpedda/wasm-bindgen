...
extern "C" {
    ...
    pub fn get_clear_to_send(this: &SerialInputSignals) -> Option<bool>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_data_carrier_detect(this: &SerialInputSignals) -> Option<bool>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_data_set_ready(this: &SerialInputSignals) -> Option<bool>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_ring_indicator(this: &SerialInputSignals) -> Option<bool>;
    #[cfg(web_sys_unstable_apis)]
