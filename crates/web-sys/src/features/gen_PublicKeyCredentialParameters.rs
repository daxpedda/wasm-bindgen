...
extern "C" {
    ...
    pub fn get_alg(this: &PublicKeyCredentialParameters) -> Option<i32>;
    ...
    pub fn get_type_(this: &PublicKeyCredentialParameters) -> Option<PublicKeyCredentialType>;
    #[cfg(feature = "PublicKeyCredentialType")]
    #[doc = "Change the `type` field of this object."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `PublicKeyCredentialParameters`, `PublicKeyCredentialType`*"]
    #[wasm_bindgen(method, setter = "type")]
    pub fn set_type_(this: &PublicKeyCredentialParameters, val: PublicKeyCredentialType);
}
