...
extern "C" {
    ...
    pub fn get_challenge(this: &CollectedClientData) -> Option<String>;
    ...
    pub fn get_hash_algorithm(this: &CollectedClientData) -> Option<String>;
    ...
    pub fn get_origin(this: &CollectedClientData) -> Option<String>;
    ...
    pub fn get_type_(this: &CollectedClientData) -> Option<String>;
    #[doc = "Change the `type` field of this object."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `CollectedClientData`*"]
    #[wasm_bindgen(method, setter = "type")]
    pub fn set_type_(this: &CollectedClientData, val: &str);
}
