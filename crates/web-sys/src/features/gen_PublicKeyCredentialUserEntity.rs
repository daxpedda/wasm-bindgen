...
extern "C" {
    ...
    pub fn get_name(this: &PublicKeyCredentialUserEntity) -> Option<String>;
    ...
    pub fn get_display_name(this: &PublicKeyCredentialUserEntity) -> Option<String>;
    ...
    pub fn get_id(this: &PublicKeyCredentialUserEntity) -> Option<::js_sys::Object>;
