...
extern "C" {
    ...
    pub fn get_index(this: &UsbControlTransferParameters) -> Option<u16>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_recipient(this: &UsbControlTransferParameters) -> Option<UsbRecipient>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "UsbRecipient")]
    ...
    pub fn get_request(this: &UsbControlTransferParameters) -> Option<u8>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_request_type(this: &UsbControlTransferParameters) -> Option<UsbRequestType>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "UsbRequestType")]
    ...
    pub fn get_value(this: &UsbControlTransferParameters) -> Option<u16>;
    #[cfg(web_sys_unstable_apis)]
