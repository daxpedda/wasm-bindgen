...
extern "C" {
    ...
    pub fn get_receiver(this: &RtcTrackEventInit) -> Option<RtcRtpReceiver>;
    #[cfg(feature = "RtcRtpReceiver")]
    ...
    pub fn get_track(this: &RtcTrackEventInit) -> Option<MediaStreamTrack>;
    #[cfg(feature = "MediaStreamTrack")]
    ...
    pub fn get_transceiver(this: &RtcTrackEventInit) -> Option<RtcRtpTransceiver>;
    #[cfg(feature = "RtcRtpTransceiver")]
