...
extern "C" {
    ...
    pub fn get_description(this: &WidevineCdmManifest) -> Option<String>;
    ...
    pub fn get_name(this: &WidevineCdmManifest) -> Option<String>;
    ...
    pub fn get_version(this: &WidevineCdmManifest) -> Option<String>;
    ...
    pub fn get_x_cdm_codecs(this: &WidevineCdmManifest) -> Option<String>;
    ...
    pub fn get_x_cdm_host_versions(this: &WidevineCdmManifest) -> Option<String>;
    ...
    pub fn get_x_cdm_interface_versions(this: &WidevineCdmManifest) -> Option<String>;
    ...
    pub fn get_x_cdm_module_versions(this: &WidevineCdmManifest) -> Option<String>;
