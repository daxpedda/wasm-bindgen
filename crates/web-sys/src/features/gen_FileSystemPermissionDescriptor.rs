...
extern "C" {
    ...
    pub fn get_name(this: &FileSystemPermissionDescriptor) -> Option<PermissionName>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "PermissionName")]
    ...
    pub fn get_handle(this: &FileSystemPermissionDescriptor) -> Option<FileSystemHandle>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "FileSystemHandle")]
