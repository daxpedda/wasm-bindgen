...
extern "C" {
    ...
    pub fn get_codec(this: &VideoEncoderConfig) -> Option<String>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_height(this: &VideoEncoderConfig) -> Option<u32>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_width(this: &VideoEncoderConfig) -> Option<u32>;
    #[cfg(web_sys_unstable_apis)]
