...
extern "C" {
    ...
    pub fn get_id(this: &PublicKeyCredentialDescriptor) -> Option<::js_sys::Object>;
    ...
    pub fn get_type_(this: &PublicKeyCredentialDescriptor) -> Option<PublicKeyCredentialType>;
    #[cfg(feature = "PublicKeyCredentialType")]
    #[doc = "Change the `type` field of this object."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `PublicKeyCredentialDescriptor`, `PublicKeyCredentialType`*"]
    #[wasm_bindgen(method, setter = "type")]
    pub fn set_type_(this: &PublicKeyCredentialDescriptor, val: PublicKeyCredentialType);
}
