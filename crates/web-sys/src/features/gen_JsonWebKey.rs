...
extern "C" {
    ...
    pub fn get_kty(this: &JsonWebKey) -> Option<String>;
    ...
    pub fn get_use_(this: &JsonWebKey) -> Option<String>;
    #[doc = "Change the `use` field of this object."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `JsonWebKey`*"]
    #[wasm_bindgen(method, setter = "use")]
    pub fn set_use_(this: &JsonWebKey, val: &str);
...
impl JsonWebKey {
    ...
    #[deprecated = "Use `set_use_()` instead."]
