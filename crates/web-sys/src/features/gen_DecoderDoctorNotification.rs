...
extern "C" {
    ...
    pub fn get_decoder_doctor_report_id(this: &DecoderDoctorNotification) -> Option<String>;
    ...
    pub fn get_is_solved(this: &DecoderDoctorNotification) -> Option<bool>;
    ...
    pub fn get_type_(this: &DecoderDoctorNotification) -> Option<DecoderDoctorNotificationType>;
    #[cfg(feature = "DecoderDoctorNotificationType")]
    #[doc = "Change the `type` field of this object."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `DecoderDoctorNotification`, `DecoderDoctorNotificationType`*"]
    #[wasm_bindgen(method, setter = "type")]
    pub fn set_type_(this: &DecoderDoctorNotification, val: DecoderDoctorNotificationType);
}
impl DecoderDoctorNotification {
    ...
    #[cfg(feature = "DecoderDoctorNotificationType")]
    #[deprecated = "Use `set_type_()` instead."]
