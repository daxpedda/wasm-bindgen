...
extern "C" {
    ...
    pub fn get_coded_height(this: &VideoFrameBufferInit) -> Option<u32>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_coded_width(this: &VideoFrameBufferInit) -> Option<u32>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_format(this: &VideoFrameBufferInit) -> Option<VideoPixelFormat>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "VideoPixelFormat")]
    ...
    pub fn get_timestamp(this: &VideoFrameBufferInit) -> Option<f64>;
    #[cfg(web_sys_unstable_apis)]
