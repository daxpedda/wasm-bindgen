...
extern "C" {
    ...
    pub fn get_name(this: &HmacKeyAlgorithm) -> Option<String>;
    ...
    pub fn get_hash(this: &HmacKeyAlgorithm) -> Option<KeyAlgorithm>;
    #[cfg(feature = "KeyAlgorithm")]
    ...
    pub fn get_length(this: &HmacKeyAlgorithm) -> Option<u32>;
