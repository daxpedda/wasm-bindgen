...
extern "C" {
    ...
    pub fn get_added(this: &XrInputSourcesChangeEventInit) -> Option<::js_sys::Array>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_removed(this: &XrInputSourcesChangeEventInit) -> Option<::js_sys::Array>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_session(this: &XrInputSourcesChangeEventInit) -> Option<XrSession>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "XrSession")]
