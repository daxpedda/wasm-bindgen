...
extern "C" {
    ...
    pub fn get_challenge(this: &PublicKeyCredentialCreationOptions) -> Option<::js_sys::Object>;
    ...
    pub fn get_rp(this: &PublicKeyCredentialCreationOptions)
        -> Option<PublicKeyCredentialRpEntity>;
    #[cfg(feature = "PublicKeyCredentialRpEntity")]
