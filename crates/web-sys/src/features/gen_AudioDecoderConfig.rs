...
extern "C" {
    ...
    pub fn get_codec(this: &AudioDecoderConfig) -> Option<String>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_number_of_channels(this: &AudioDecoderConfig) -> Option<u32>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_sample_rate(this: &AudioDecoderConfig) -> Option<u32>;
    #[cfg(web_sys_unstable_apis)]
