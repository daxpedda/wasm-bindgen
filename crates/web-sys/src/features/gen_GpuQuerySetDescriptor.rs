...
extern "C" {
    ...
    pub fn get_count(this: &GpuQuerySetDescriptor) -> Option<u32>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_type_(this: &GpuQuerySetDescriptor) -> Option<GpuQueryType>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "GpuQueryType")]
    ...
    pub fn set_type_(this: &GpuQuerySetDescriptor, val: GpuQueryType);
}
#[cfg(web_sys_unstable_apis)]
