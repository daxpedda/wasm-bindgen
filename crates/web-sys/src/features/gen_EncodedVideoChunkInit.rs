...
extern "C" {
    ...
    pub fn get_data(this: &EncodedVideoChunkInit) -> Option<::js_sys::Object>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_timestamp(this: &EncodedVideoChunkInit) -> Option<f64>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn get_type_(this: &EncodedVideoChunkInit) -> Option<EncodedVideoChunkType>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "EncodedVideoChunkType")]
    ...
    pub fn set_type_(this: &EncodedVideoChunkInit, val: EncodedVideoChunkType);
}
#[cfg(web_sys_unstable_apis)]
