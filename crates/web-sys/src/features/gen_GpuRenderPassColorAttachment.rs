...
extern "C" {
    ...
    pub fn get_load_op(this: &GpuRenderPassColorAttachment) -> Option<GpuLoadOp>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "GpuLoadOp")]
    ...
    pub fn get_store_op(this: &GpuRenderPassColorAttachment) -> Option<GpuStoreOp>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "GpuStoreOp")]
    ...
    pub fn get_view(this: &GpuRenderPassColorAttachment) -> Option<GpuTextureView>;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "GpuTextureView")]
