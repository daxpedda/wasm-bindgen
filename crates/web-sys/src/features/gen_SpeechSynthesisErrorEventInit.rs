...
extern "C" {
    ...
    pub fn get_utterance(this: &SpeechSynthesisErrorEventInit) -> Option<SpeechSynthesisUtterance>;
    #[cfg(feature = "SpeechSynthesisUtterance")]
    ...
    pub fn get_error(this: &SpeechSynthesisErrorEventInit) -> Option<SpeechSynthesisErrorCode>;
    #[cfg(feature = "SpeechSynthesisErrorCode")]
